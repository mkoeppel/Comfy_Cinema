...
def recommender():
    ...
    nmf_img = calculate_best_movies(user_input_movies, user_input_ratings)
    cos_img = similar_users_recommender(user_input_movies, user_input_ratings)
    return render_template("recommendations.html", nmf_img=nmf_img, cos_img=cos_img) #

if __name__ == "__main__":

    app.run(debug = False)   # this will start an infinite process, i.e. serving our web page.
